...
void BitcoinGUI::createActions()
{
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DigitalPrice"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DigitalPrice addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DigitalPrice addresses"));
...
{
    QString strTitle = tr("DigitalPrice"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid DigitalPrice address or malformed URI parameters."),
